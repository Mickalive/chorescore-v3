...
FAIL __tests__/domain/v3-08-finalizer-wrapper.test.ts
  ● V3-08 finalizer wrapper contract › consecutiveEmptyMatchCount increment is guarded on real dump (cache miss)

    expect(received).toContain(expected) // indexOf

    Expected substring: "Cache hits must NOT increment the counter"
    ...
    [0m [90m 287 |[39m     expect(e2e)[33m.[39mtoMatch([35m/!nodes\._fromCache\s*&&\s*dumpFailures\s*<=\s*previousDumpFailures/[39m)[33m;[39m
     [90m 288 |[39m     [90m// The comment must explain why cache hits are excluded[39m
    [31m[1m>[22m[39m[90m 289 |[39m     expect(e2e)[33m.[39mtoContain([32m'Cache hits must NOT increment the counter'[39m)[33m;[39m
     [90m     |[39m                 [31m[1m^[22m[39m
     [90m 290 |[39m   })[33m;[39m
     [90m 291 |[39m
     [90m 292 |[39m   test([32m'screenshot reuses cached dump instead of triggering fresh uiautomator dump'[39m[33m,[39m () [33m=>[39m {[0m

      at Object.toContain (__tests__/domain/v3-08-finalizer-wrapper.test.ts:289:17)
...
Tests:       1 failed, 450 passed, 451 total
Snapshots:   0 total
Time:        5.026 s
Ran all test suites.
